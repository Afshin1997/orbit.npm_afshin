...
import prisma_walker.mdp as mdp
...
class CommandsCfg:
    ...
    base_velocity = mdp.NullCommandCfg()
...
class EventCfg:
    ...
    add_base_mass = EventTerm(
        ...
        mode="startup",
        params={"asset_cfg": SceneEntityCfg("robot", body_names="base_link"), "mass_range": (-0.2, 1.0)},
    )
...
class RewardsCfg:
    ...
    ang_vel_x_l2 = RewTerm(func=mdp.ang_vel_x_l2, weight=-0.5)
    dof_torques_l2 = RewTerm(func=mdp.joint_torques_l2, weight=-1.0e-5)
    dof_vel_l2 = RewTerm(func=mdp.joint_vel_l2, weight=-1.0e-3)
    action_rate_l2 = RewTerm(func=mdp.action_rate_l2, weight=-0.01)
    imitation = RewTerm(func=mdp.imitation, weight=1)
  
    # -- optional penalties
    #dof_pos_limits = RewTerm(func=mdp.joint_pos_limits, weight=0.001)
...
class TerminationsCfg:
    ...
    yaw_condition = DoneTerm(
        func=mdp.yawCondition,
